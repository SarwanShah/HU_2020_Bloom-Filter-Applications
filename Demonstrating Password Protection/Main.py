...
'''Generating a filter from a database file and outputting it to a file'''
generatePasswordFilterFile('TestData.txt', 'MainFilterFile.txt')

'''Loading a filter from a file'''
